/**
 * ================================
 * DOCUMENT UPLOAD FIELD VALIDATION
 * ================================
 * Zod schema generation for Document Upload fields based on field rules
...
/**
 * Generate Zod schema for Document Upload field based on field rules
 * 
 * @param field - Field configuration from API
 * @returns Zod schema for document upload validation
 */
export const generateDocumentUploadSchema = (field: FormField): z.ZodType<File | null> => {
  ...
  console.debug('[documentUploadValidation] Generating schema for field:', {
...
export const validateDocumentUpload = (
  ...
  const schema = generateDocumentUploadSchema(field);
...
/**
 * Get default document value from field configuration
 * 
 * @param field - Field configuration
 * @returns Default document value (null for uploads)
 */
export const getDefaultDocumentUploadValue = (_field: FormField): null => {
 ...
 * @returns Human-readable string (e.g., "PDF, Word, Excel")
 */
