// src/features/formVersion/components/fields/RadioButtonFieldConfig.tsx
...
type RadioButtonFieldConfigProps = {
  field: Field;
  fieldIndex: number;
...
export function RadioButtonFieldConfig({
  field,
  fieldIndex,
  onFieldChange,
  onDelete,
}: RadioButtonFieldConfigProps) {
      ...
      <div className="space-y-3">
        ...
        <Alert className="bg-cyan-50 border-cyan-200">
          ...
          <AlertDescription className="text-xs text-cyan-900">
            Single-choice selection field. User can select ONE option from
            predefined choices. Perfect for mutually exclusive options like
            gender, yes/no, or priority levels.
          </AlertDescription>
        </Alert>
