// src/features/formVersion/components/fields/DropdownSelectFieldConfig.tsx
...
type DropdownSelectFieldConfigProps = {
  field: Field;
  fieldIndex: number;
...
export function DropdownSelectFieldConfig({
  field,
  fieldIndex,
  onFieldChange,
  onDelete,
}: DropdownSelectFieldConfigProps) {
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-1.5">
          ...
          >
            ...
            <SelectContent>
              <SelectItem value="">No default selection</SelectItem>
              {options.map((option, index) => (
        ...
        <div className="p-3 border rounded-md bg-muted/30">
          ...
          <div className="space-y-1 text-[10px] text-muted-foreground">
            <div>
              • <strong>Country/State:</strong> Long lists of geographic locations
            </div>
            <div>
          ...
          <p className="text-[10px] text-sky-700 mt-2">
            💡 <strong>Tip:</strong> Use dropdown instead of radio buttons when you
            have 5+ options
          </p>
        </div>
