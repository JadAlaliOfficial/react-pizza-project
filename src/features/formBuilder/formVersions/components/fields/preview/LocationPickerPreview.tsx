// src/features/formVersion/components/fields/preview/LocationPickerPreview.tsx

/**
 * Location Picker Preview Component
 *
 * Displays a preview of how the Location Picker field will appear in the form
 * Shows map UI with marker, search, and location details
 */
...
/**
 * LocationPickerPreview Component
 *
 * Preview component for Location Picker field type
 * Features:
 * - Label with map icon and badge
 * - Disabled search + map controls
 * - Center marker and simulated map background
 * - Location details summary
 * - Rule/required hints
 */
export const LocationPickerPreview: React.FC<FieldPreviewComponentProps> = ({
  field,
}) => {
  console.debug('[LocationPickerPreview] Rendering for field:', field.id);
