      ...
      <div className="space-y-3">
        ...
        <Alert className="bg-purple-50 border-purple-200">
          ...
          <AlertDescription className="text-xs text-purple-900">
            Combines date and time in a single field. Automatically normalized to Y-m-d H:i:s format (YYYY-MM-DD HH:MM:SS). Perfect for appointments, events, and timestamps.
          </AlertDescription>
        </Alert>
        ...
        <div className="space-y-1.5">
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              variant="outline"
              size="sm"
              onClick={() => onFieldChange({ default_value: getCurrentDateTime() })}
        ...
        <div className="p-3 border rounded-md bg-muted/30">
          ...
          <p className="text-[10px] text-purple-700 mt-2">
            💡 Use validation rules (before, after, min) to enforce datetime restrictions
          </p>
        </div>
        ...
        <Alert className="bg-amber-50 border-amber-200">
          ...
          <AlertDescription className="text-xs text-amber-900">
            <strong>Timezone:</strong> Values are stored in server timezone. Consider adding helper text about timezone if working with international users.
          </AlertDescription>
        </Alert>
