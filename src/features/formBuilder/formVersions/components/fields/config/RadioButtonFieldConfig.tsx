// src/features/formVersion/components/fields/config/RadioButtonFieldConfig.tsx
 ...
 * - Live radio group preview for default selection
 * - JSON options storage in placeholder field
 * - Minimum 1 option validation
 */
export const RadioButtonFieldConfig: React.FC<FieldConfigComponentProps> = ({
  field,
  fieldIndex,
  onFieldChange,
  onDelete,
