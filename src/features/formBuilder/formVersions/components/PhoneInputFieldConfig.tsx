// src/features/formVersion/components/fields/PhoneInputFieldConfig.tsx
...
type PhoneInputFieldConfigProps = {
  field: Field;
  fieldIndex: number;
...
export function PhoneInputFieldConfig({
  field,
  fieldIndex,
  onFieldChange,
  onDelete,
}: PhoneInputFieldConfigProps) {
      ...
      <div className="space-y-3">
        ...
        <Alert className="bg-cyan-50 border-cyan-200">
          ...
          <AlertDescription className="text-xs text-cyan-900">
            Phone numbers are stored AS-IS (no auto-formatting). Use regex
            validation rules to enforce specific formats. Supports country code
            filtering.
          </AlertDescription>
        </Alert>
