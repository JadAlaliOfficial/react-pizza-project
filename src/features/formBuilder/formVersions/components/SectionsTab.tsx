 ...
 * - Add/delete sections
 * - Edit section name and order
 * - Configure visibility conditions
 * - Shows which stage is currently being edited
 */
...
import type { Stage, Section } from "@/features/formBuilder/formVersions/types";
      ...
      <div className="space-y-3">
        ...
        {!currentStage?.sections || currentStage.sections.length === 0 ? (
          ...
          currentStage.sections.map((section, sectionIndex) => (
            <Card key={section.id ?? `section-${sectionIndex}`} className="p-4">
              <div className="space-y-3">
