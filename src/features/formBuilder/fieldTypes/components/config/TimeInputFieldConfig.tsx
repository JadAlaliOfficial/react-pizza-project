// src/features/formVersion/components/fields/TimeInputFieldConfig.tsx
...
type TimeInputFieldConfigProps = {
  field: Field;
  fieldIndex: number;
...
export function TimeInputFieldConfig({
  field,
  fieldIndex,
  onFieldChange,
  onDelete,
}: TimeInputFieldConfigProps) {
      ...
      <div className="space-y-3">
        ...
        <Alert className="bg-teal-50 border-teal-200">
          ...
          <AlertDescription className="text-xs text-teal-900">
            Times are automatically normalized to H:i:s format (HH:MM:SS -
            24-hour). Supports time validation rules like before, after, and
            time ranges.
          </AlertDescription>
        </Alert>
        ...
        <div className="p-3 border rounded-md bg-muted/30">
          ...
          <p className="text-[10px] text-teal-700 mt-2">
            💡 Use validation rules (before, after, date_format) to enforce
            time restrictions
          </p>
        </div>
