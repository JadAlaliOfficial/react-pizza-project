// src/features/formVersion/components/fields/DateInputFieldConfig.tsx
...
type DateInputFieldConfigProps = {
  field: Field;
  fieldIndex: number;
...
export function DateInputFieldConfig({
  field,
  fieldIndex,
  onFieldChange,
  onDelete,
}: DateInputFieldConfigProps) {
      ...
      <div className="space-y-3">
        ...
        <Alert className="bg-indigo-50 border-indigo-200">
          ...
          <AlertDescription className="text-xs text-indigo-900">
            Dates are automatically normalized to Y-m-d format (YYYY-MM-DD).
            Supports date validation rules like before, after, and date ranges.
          </AlertDescription>
        </Alert>
        ...
        <div className="p-3 border rounded-md bg-muted/30">
          ...
          <p className="text-[10px] text-indigo-700 mt-2">
            💡 Use validation rules (before, after, min, max) to enforce date
            restrictions
          </p>
        </div>
