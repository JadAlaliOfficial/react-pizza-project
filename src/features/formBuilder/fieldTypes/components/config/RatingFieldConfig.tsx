      ...
      <div className="space-y-3">
        ...
        <div className="pt-2 border-t">
          ...
          <p className="text-[10px] text-amber-700 mt-2 font-medium">
            ⚠️ Note: Rating field is NOT configured for min, max, between,
            numeric, or integer validation rules in the backend. Only "required"
            rule is available.
          </p>
        </div>
