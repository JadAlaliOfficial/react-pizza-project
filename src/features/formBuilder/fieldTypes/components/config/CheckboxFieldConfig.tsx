// src/features/formVersion/components/fields/CheckboxFieldConfig.tsx
      ...
      <div className="space-y-3">
        ...
        <Alert className="bg-emerald-50 border-emerald-200">
          ...
          <AlertDescription className="text-xs text-emerald-900">
            Boolean field with checked/unchecked states. Value is normalized to
            "1" (checked) or "0" (unchecked). Perfect for agreements, opt-ins,
        ...
        <div className="p-3 border rounded-md bg-muted/30">
          ...
          <p className="text-[10px] text-emerald-700 mt-2">
            💡 Use "required" validation to make checkbox mandatory (must be
            checked)
          </p>
        </div>
        ...
        <Alert className="bg-amber-50 border-amber-200">
          ...
          <AlertDescription className="text-xs text-amber-900">
            <strong>Note:</strong> Checkboxes don't use placeholder text. The
            label serves as the checkbox description.
          </AlertDescription>
        </Alert>
